...
#Create an empty sey using the set() function
#my_set = set()
#print(my_set)
...
#Removing 8 from the set without throwing and error if 8 is not on the set
...
common_intrests = blertas_interest.intersection(drilonis_interests)
